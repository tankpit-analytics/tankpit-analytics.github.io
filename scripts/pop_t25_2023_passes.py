...
if __name__ == '__main__':
    # load and clean
    master_df = pd.read_csv(master_csv_2023)
    passes_df = pd.read_csv(passes_csv_2023)
    passes_df = clean_passes_df(passes_df, pop_t_2023_rows)
    passes_df = passes_df.head(pop_t_2023_passes_max_display)
    # get
    ...
    # pop
    with open(pop_t_2023_passes_md, 'w') as f:
        f.write('\n## 2023 Top 25 - Passes\n\n')
