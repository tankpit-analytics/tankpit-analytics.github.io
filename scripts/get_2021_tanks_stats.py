...
if __name__ == '__main__':
    ...
    y2021_tanks = only_keep_has_any_award(y2021_tanks, awards_dict) # new addition - greatly reduces runtime
    y2021_tanks = rank_by_awards(y2021_tanks, awards_dict)
    y2021_tanks = run_half_loop(y2021_tanks)
    # save
