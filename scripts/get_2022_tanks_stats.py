...
if __name__ == '__main__':
    ...
    y2022_tanks = only_keep_has_any_award(y2022_tanks, awards_dict) # new addition - greatly reduces runtime
    y2022_tanks = rank_by_awards(y2022_tanks, awards_dict)
    y2022_tanks = run_half_loop(y2022_tanks)
    # save
