...
$PYTHON $SCRIPTSDIR/pop_t25_2023.py >> $STDLOG 2>&1
$PYTHON $SCRIPTSDIR/pop_t100_overall_passes.py >> $STDLOG 2>&1
$PYTHON $SCRIPTSDIR/pop_t25_2023_passes.py >> $STDLOG 2>&1
...
#$PYTHON $SCRIPTSDIR/get_roster_col.py >> $LOGDIR/get_roster_col.log 2>&1 # 2023-specific
#$PYTHON $SCRIPTSDIR/get_130k_club.py >> $LOGDIR/get_130k_club.log 2>&1 # 16 sec
$PYTHON $SCRIPTSDIR/get_2023_tanks.py >> $LOGDIR/get_2023_tanks.log 2>&1 # 47 sec
$PYTHON $SCRIPTSDIR/get_all_tanks.py >> $LOGDIR/get_all_tanks.log 2>&1 # 35 min
$PYTHON $SCRIPTSDIR/get_2023_tanks_stats.py >> $LOGDIR/get_2023_tanks_stats.log 2>&1 # 3 min
...
# populate the rest (last updated: all_tanks.csv / 2023_tanks.csv - above "data")
...
$PYTHON $SCRIPTSDIR/pop_stats_2023.py >> $STDLOG 2>&1
