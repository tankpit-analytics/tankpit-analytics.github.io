...
$PYTHON $SCRIPTSDIR/pop_t25_2021.py >> $STDLOG 2>&1
$PYTHON $SCRIPTSDIR/pop_t100_overall_passes.py >> $STDLOG 2>&1
$PYTHON $SCRIPTSDIR/pop_t25_2021_passes.py >> $STDLOG 2>&1
...
$PYTHON $SCRIPTSDIR/get_2021_tanks.py >> $LOGDIR/get_2021_tanks.log 2>&1 # 47 sec
$PYTHON $SCRIPTSDIR/get_all_tanks.py >> $LOGDIR/get_all_tanks.log 2>&1 # 35 min
$PYTHON $SCRIPTSDIR/get_2021_tanks_stats.py >> $LOGDIR/get_2021_tanks_stats.log 2>&1 # 3 min
...
# populate the rest (last updated: all_tanks.csv / 2021_tanks.csv - above "data")
...
$PYTHON $SCRIPTSDIR/pop_stats_2021.py >> $STDLOG 2>&1
